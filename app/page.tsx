            ...
            <aside className="flex flex-col gap-6">
               ...
               <div className="border-t border-white/5 ">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                     {[
                        ...
                        { title: "Standard", label: "", subtitle: "9' x 3'" },
                           ...
                           >
                              <div
                                 className={`text-sm font-semibold ${
                                    selected ? "text-[#ffc261]" : "text-white"
                                 }`}
                              >
                                 {opt.title}
                              </div>
               ...
               <div className="pt-4">
                  ...
                  <p className="text-white/70">
                     ...
                     daily on a quality, tour-grade turf putting green for both
                     indoors &amp; outdoors. Our product offers a true roll with
                     a 9–11 Stimpmeter reading and the most realistic experience
                     you'll find anywhere outside a real course.
                  </p>
               </div>
                  ...
                  sections={[
                     {
                        ...
                        content: (
                           <ul className="list-disc pl-5 space-y-2 text-white/80">
                              ...
                              <li>
                                 Designed to fit spaces of any size, from living
                                 rooms and offices to studio apartments.
                              </li>
                              <li>
                     ...
                     },
                     {
                        ...
                        content: (
                           <ul className="list-disc pl-5 space-y-2 text-white/80">
                              ...
                              <li>
                                 Alignment aids at three-foot intervals that let
                     ...
                     },
                     {
                        ...
                        content: (
                           <p className="text-white/80">
                              Start practice in less than a few minutes. Simply
                              open the box, unroll the mat, position the
                              backstop, set up your cups, and start putting.
                           </p>
                        ),
                     },
                     {
                        ...
                        content: (
                           <div className="text-white/80 space-y-4">
                              <p>
                                 ...
                                 putting is to lowering your scores, so we set
                                 out to create the most realistic, high-quality
                                 putting mat on the market. In doing so, we
                                 dedicated months of research alongside
                                 turf-grass experts, material scientists, and
                                 PGA professionals to find the closest surface
                                 to a real grass putting green.
                              </p>

                              <p>
                                 Our tour-grade nylon turf material guarantees
                                 the most realistic feedback of any other
                                 putting mat, which is why PGA tour pros and
                                 golf experts everywhere use it. Regardless of
                                 skill level, PrimePutt offers the perfect
                                 practice surface for golfers looking to lower
                                 their scores and build short-game confidence.
                                 And no matter what home or office space you
                                 have to dedicate to your practice time, our
                                 various sizes provide the flexibility to fit
                                 any area and practice any distance.
                              </p>

                              <p>
                                 Even better, PrimePutt's proprietary cup design
                                 guarantees you'll never have a putt blocked by
                                 another ball. At the same time, these
                                 innovative cups perfectly replicate full-depth
                                 golf cups: the misses miss, and the makes go
                                 in. For setup, our specially-designed
                                 rubberized bottom and no-memory material mean
                                 the PrimePutt mat lays flat and doesn't move
                                 right out of the box every time. These same
                                 materials lend incredible durability to our
                                 putting mats, so you can use yours indoors or
                                 outdoors, putt with the kids, and let the dog
                                 walk over it—still rest assured that your
                              ...
                              <p>
                                 ...
                                 three-putting from longer distances, and start
